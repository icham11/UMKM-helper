...
export default function DebtsPage() {
  ...
  function printReceipt(debt: Debt, paymentAmount?: number) {
    ...
    w.document.write(`<!DOCTYPE html><html><head><title>Bukti Kasbon</title>
      ...
      <div class="center">
        <h2>${business?.name || "UMKM Helper"}</h2>
      ...
      <div class="divider"></div>
      <p class="center" style="font-size:10px;color:#999;margin-top:8px">Dicetak oleh UMKM Helper<br/>${now}</p>
      </body></html>`);
    w.document.close();
    w.print();
  }
      ...
      <div className="flex gap-3 flex-wrap">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-amber-300 focus:outline-none"
          />
        </div>
